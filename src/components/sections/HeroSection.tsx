...
const HeroSection = () => {
  ...
  return (
    <section className="relative min-h-screen text-white bg-background">
      ...
      <div className="hidden sm:block absolute top-20 left-10 w-48 sm:w-72 h-48 sm:h-72 bg-primary/10 rounded-full blur-3xl animate-pulse-glow" />
      <div className="hidden sm:block absolute bottom-20 right-10 w-48 sm:w-96 h-48 sm:h-96 bg-accent/10 rounded-full blur-3xl animate-pulse-glow" style={{ animationDelay: "1.5s" }} />

      {/* Content */}
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 min-h-screen flex items-center">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center w-full py-12 sm:py-20">
          {/* Left Content */}
          <div className="space-y-6 sm:space-y-8">
            <div className="space-y-4">
              ...
              <h1 className="text-3xl sm:text-5xl md:text-7xl lg:text-8xl xl:text-9xl font-display font-bold text-white leading-[0.85] tracking-tight drop-shadow-2xl">
                    The Art of <br/>
            ...
            {/* <div className="flex flex-col sm:flex-row gap-4 animate-fade-in" style={{ animationDelay: "0.8s" }}>
              ...
              <Button size="lg" variant="outline" className="text-lg px-8 py-6 border-border/50 hover:bg-secondary/50 hover:border-primary/50 font-medium">
                ...
                <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
                  <Link to="/marketplace">
                <Button size="lg" className="bg-primary text-primary-foreground hover:bg-primary/80 text-base sm:text-lg px-6 sm:px-8 w-full sm:w-auto">
                  Browse Snakes
                </Button>
                  </Link>
                <Button size="lg" variant="outline" className="text-base sm:text-lg px-6 sm:px-8 hover:bg-white hover:text-black w-full sm:w-auto">
                  Become a Seller
                </Button>
              </div>
