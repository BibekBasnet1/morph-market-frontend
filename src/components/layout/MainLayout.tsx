...
const MainLayout: React.FC<MainLayoutProps> = ({ children }) => {
  ...
  return (
    <div className="min-h-screen w-full dark:bg-black xl:flex">
      ...
      <div
        className={`flex-1 max-w-full flex flex-col transition-all duration-300 ease-in-out ${mainMargin} ${isMobileOpen ? "ml-0" : ""}`}
      >
        <Navbar />
