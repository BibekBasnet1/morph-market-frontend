...
const hasAccess = (allowedRoles: RoleName[]) =>
  ...
  return (
    <aside
      className={`fixed dark:bg-black bg-white flex flex-col  top-0 px-5 left-0  h-screen max-h-screen overflow-y-auto transition-all duration-300 ease-in-out z-50 border-r dark:border-gray-700 border-gray-200 
        ${
